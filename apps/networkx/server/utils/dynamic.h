...
// Type string to Type
static inline gart::rpc::DataType Str2RpcType(const std::string& s) {
  static const std::map<std::string, gart::rpc::DataType> str2type = {
      {"NULL", gart::rpc::DataType::NULLVALUE},
      {"null", gart::rpc::DataType::NULLVALUE},
      {"BOOL", gart::rpc::DataType::BOOL},
      {"bool", gart::rpc::DataType::BOOL},
      {"boolean", gart::rpc::DataType::BOOL},
      {"INT", gart::rpc::DataType::INT},
      {"int", gart::rpc::DataType::INT},
      {"int32", gart::rpc::DataType::INT},
      {"int32_t", gart::rpc::DataType::INT},
      {"LONG", gart::rpc::DataType::LONG},
      {"long", gart::rpc::DataType::LONG},
      {"int64", gart::rpc::DataType::LONG},
      {"int64_t", gart::rpc::DataType::LONG},
      {"FLOAT", gart::rpc::DataType::DOUBLE},
      {"float", gart::rpc::DataType::DOUBLE},
      {"float32", gart::rpc::DataType::DOUBLE},
      {"DOUBLE", gart::rpc::DataType::DOUBLE},
      {"double", gart::rpc::DataType::DOUBLE},
      {"float64", gart::rpc::DataType::DOUBLE},
      {"STRING", gart::rpc::DataType::STRING},
      {"str", gart::rpc::DataType::STRING},
      {"string", gart::rpc::DataType::STRING},
  };
  return str2type.at(s);
}

static inline gart::rpc::DataType DynamicType2RpcType(const Type& t) {
  static const std::map<Type, gart::rpc::DataType> type2type = {
      {Type::kNullType, gart::rpc::DataType::NULLVALUE},
      {Type::kBoolType, gart::rpc::DataType::BOOL},
      {Type::kInt32Type, gart::rpc::DataType::INT},
      {Type::kInt64Type, gart::rpc::DataType::LONG},
      {Type::kDoubleType, gart::rpc::DataType::DOUBLE},
      {Type::kStringType, gart::rpc::DataType::STRING},
      {Type::kArrayType, gart::rpc::DataType::INT_LIST},
      {Type::kObjectType, gart::rpc::DataType::DYNAMIC}};
...
template <>
struct hash<::gart::dynamic::Value> {
  std::size_t operator()(::gart::dynamic::Value const& d) const {
    return d.hash();
  }
};
...
inline grape::InArchive& operator<<(grape::InArchive& archive,
  ...
  if (value.IsInt64()) {
    ...
    std::string json = gart::dynamic::Stringify(value);
    archive << json;
  }
  return archive;
}
...
inline grape::InArchive& operator<<(grape::InArchive& archive,
                                    const gart::dynamic::Value& value) {
  if (value.IsInt64()) {
    archive << value.GetInt64();
  } else if (value.IsDouble()) {
    archive << value.GetDouble();
