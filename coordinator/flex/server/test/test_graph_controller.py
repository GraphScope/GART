...
class TestGraphController(BaseTestCase):
    ...
    def test_create_graph_by_pgql(self):
        """Test case for create_graph_by_pgql

        
        """
        create_graph_by_pgql_request = {"schema":"schema","name":"name","description":"description"}
        headers = { 
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        }
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(create_graph_by_pgql_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))

    def test_create_graph_by_yaml(self):
        """Test case for create_graph_by_yaml

        
        """
        create_graph_by_yaml_request = {"schema":"schema","name":"name","description":"description"}
        headers = { 
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        }
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(create_graph_by_yaml_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_get_graph_version_by_timestamp(self):
        """Test case for get_graph_version_by_timestamp
    ...
    def test_read_graph_by_a_given_version(self):
        """Test case for read_graph_by_a_given_version

        
        """
        change_graph_version_request = {"version_id":"version_id"}
        headers = { 
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        }
