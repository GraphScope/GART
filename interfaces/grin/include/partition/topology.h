...
GRIN_PARTITION_LIST grin_vertex_data_complete_partitions(GRIN_GRAPH,
                                                         GRIN_VERTEX);
#endif
...
GRIN_VERTEX_LIST grin_filter_master_for_vertex_list(GRIN_GRAPH,
                                                    GRIN_VERTEX_LIST);

GRIN_VERTEX_LIST grin_filter_mirror_for_vertex_list(GRIN_GRAPH,
                                                    GRIN_VERTEX_LIST);
#endif

#ifdef GRIN_TRAIT_FILTER_PARTITION_FOR_VERTEX_LIST
GRIN_VERTEX_LIST grin_filter_partition_for_vertex_list(GRIN_GRAPH,
                                                       GRIN_PARTITION,
                                                       GRIN_VERTEX_LIST);
#endif
...
GRIN_EDGE_LIST grin_filter_partition_for_edge_list(GRIN_GRAPH, GRIN_PARTITION,
                                                   GRIN_EDGE_LIST);
#endif
...
// The concept of local_complete refers to whether we can get complete data or
// properties locally in the partition. It is orthogonal to the concept of
// master/mirror which is mainly designed for data aggregation. In some
// extremely cases, master vertices may NOT contain all the data or properties
// locally.
 ...
 */
GRIN_PARTITION_LIST grin_vertex_neighbor_complete_partitions(GRIN_GRAPH,
                                                             GRIN_VERTEX);
#endif

#ifdef GRIN_TRAIT_FILTER_MASTER_NEIGHBOR_FOR_ADJACENT_LIST
GRIN_ADJACENT_LIST grin_filter_master_neighbor_for_adjacent_list(
    GRIN_GRAPH, GRIN_ADJACENT_LIST);

GRIN_ADJACENT_LIST grin_filter_mirror_neighbor_for_adjacent_list(
    GRIN_GRAPH, GRIN_ADJACENT_LIST);
#endif

#ifdef GRIN_TRAIT_FILTER_NEIGHBOR_PARTITION_FOR_ADJACENT_LIST
GRIN_ADJACENT_LIST grin_filter_neighbor_partition_for_adjacent_list(
    GRIN_GRAPH, GRIN_ADJACENT_LIST);
#endif
