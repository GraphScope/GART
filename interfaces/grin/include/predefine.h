 ...
 * The vertex list iterator related APIs follow the design principle of GRIN
 * Iterator.
 */
 ...
 * The edge list iterator related APIs follow the design principle of GRIN
 * Iterator.
 */
 ...
 * The adjacent list iterator related APIs follow the design principle of GRIN
 * Iterator.
 */
 ...
 * and the vertex data of a mirror vertex can be fetched from its master
 * partition.
 */
...
/** @ingroup PartitionAssumptionMacros
 * @brief Assume neighbors of a vertex is always local complete for all
 * vertices.
 */
#define GRIN_ASSUME_ALL_VERTEX_NEIGHBOR_LOCAL_COMPLETE

/** @ingroup PartitionAssumptionMacros
 * @brief Assume neighbors of a vertex is always local complete for master
 * vertices.
 */
...
#ifndef GRIN_ENABLE_VERTEX_LIST  // enable vertex list iterator is the
                                 // prerequisite
#undef GRIN_TRAIT_FILTER_MASTER_FOR_VERTEX_LIST
#undef GRIN_TRAIT_FILTER_PARTITION_FOR_VERTEX_LIST
#endif
...
#ifndef GRIN_ENABLE_ADJACENT_LIST  // enable adjacent list iterator is the
                                   // prerequisite
#undef GRIN_TRAIT_FILTER_MASTER_NEIGHBOR_FOR_ADJACENT_LIST
#undef GRIN_TRAIT_FILTER_NEIGHBOR_PARTITION_FOR_ADJACENT_LIST
#endif
 ...
 * @brief Enable the pure data structure Row, which is used in primary keys and
 * tables.
 */
 ...
 * property name. Please refer to the design principle of Property for details.
 */
...
/** @ingroup PropertyMacros
 * @brief Enable the vertex property table structure, from where the value of
 * property can be fetched using vertex as row index and property as column
 * index.
 */
 ...
 * GRIN_WITH_VERTEX_ORIGINAL_ID when vertices have no properties.
 */
...
/** @ingroup PropertyMacros
 * @brief Assume the original id is ONLY unique under each vertex type. This
 * means to get a vertex from the original id, the caller must also provide the
 * vertex type.
 */
...
/** @ingroup PropertyMacros
 * @brief Enable the edge property table structure, from where the value of
 * property can be fetched using edge as row index and property as column index.
 */
 ...
 * by providing the values of the primary keys. The macro is unset if
 * GRIN_WITH_EDGE_PROPERTY is NOT defined, in which case, one can use
 * GRIN_WITH_EDGE_ORIGINAL_ID when edges have no properties.
 */
 ...
 * @brief Assume property values of a vertex is always local complete for all
 * vertices.
 */
#define GRIN_ASSUME_ALL_VERTEX_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a vertex is ONLY local complete for master
 * vertices.
 */
#define GRIN_ASSUME_MASTER_VERTEX_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a vertex is local complete for all vertices
 * with a certain type.
 */
#define GRIN_ASSUME_BY_TYPE_ALL_VERTEX_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a vertex is local complete for master
 * vertices with a certain type.
 */
#define GRIN_ASSUME_BY_TYPE_MASTER_VERTEX_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume vertex data is local complete for all vertices with a certain
 * type.
 */
#define GRIN_ASSUME_BY_TYPE_ALL_VERTEX_DATA_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume vertex data is local complete for master vertices with a
 * certain type.
 */
#define GRIN_ASSUME_BY_TYPE_MASTER_VERTEX_DATA_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a edge is always local complete for all
 * edges.
 */
#define GRIN_ASSUME_ALL_EDGE_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a edge is ONLY local complete for master
 * edges.
 */
#define GRIN_ASSUME_MASTER_EDGE_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a edge is local complete for all edges with
 * a certain type.
 */
#define GRIN_ASSUME_BY_TYPE_ALL_EDGE_PROPERTY_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume property values of a edge is local complete for master edges
 * with a certain type.
 */
...
/** @ingroup PropetyAssumptionMacros
 * @brief Assume edge data is local complete for master edges with a certain
 * type.
 */
#define GRIN_ASSUME_BY_TYPE_MASTER_EDGE_DATA_LOCAL_COMPLETE

/** @ingroup PropetyAssumptionMacros
 * @brief Assume vertex neighbor is local complete for all vertices with a
 * certain type.
 */
