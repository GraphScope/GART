 ...
 */
GRIN_VERTEX grin_get_vertex_by_primay_keys(GRIN_GRAPH,
                                           GRIN_VERTEX_PROPERTY_LIST, GRIN_ROW);
#endif
 ...
 * @param GRIN_ROW the values of primary keys
 */
GRIN_EDGE grin_get_edge_by_primay_keys(GRIN_GRAPH, GRIN_EDGE_PROPERTY_LIST,
                                       GRIN_ROW);
#endif
