...
#ifndef RESEARCH_GART_VEGITO_SRC_UTIL_SERIALIZER_H_
#define RESEARCH_GART_VEGITO_SRC_UTIL_SERIALIZER_H_
...
struct serializer {
  ...
  static inline uint8_t *write(uint8_t *buf, const T &obj) {
    ...
    *p = obj;
    return reinterpret_cast<uint8_t *>(p + 1);
  }
...
#endif  // RESEARCH_GART_VEGITO_SRC_UTIL_SERIALIZER_H_
